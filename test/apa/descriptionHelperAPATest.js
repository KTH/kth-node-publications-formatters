...
describe('DescriptionHelper', function () {
  ...
  describe('Rules for formatting the description of a publication of the type Article.', function () {
    ...
    it('hostTitle and hostSubtitle should be displayed in italic and separated by a colon.', function () {
      ...
      helper.getDescription('refereedArticles', publication, 'sv', 'apa').should.equal(' <i>The host title : The host subtitle</i>')
    })
  ...
  describe('Rules for formatting the description of a publication of the type ConferencePaper.', function () {
    ...
    it('Title should be displayed in italic.', function () {
      ...
      helper.getDescription('refereedConferencePaper', publication, 'sv', 'apa').should.equal(' I <i>The host title.</i>')
    })
    ...
    it('Title and subtitle should be displayed in italic and separated by a colon.', function () {
      ...
      helper.getDescription('refereedConferencePaper', publication, 'sv', 'apa').should.equal(' I <i>The host title: The host subtitle.</i>')
    })
    ...
    it('hostExtentStart and hostExtentEnd should be in parenthesis and preceded by s. or pp.', function () {
      ...
      helper.getDescription('refereedConferencePaper', publication, 'sv', 'apa').should.equal(' I <i>The host title: The host subtitle.</i> (s. 283-285).')
      helper.getDescription('refereedConferencePaper', publication, 'en', 'apa').should.equal(' In <i>The host title: The host subtitle.</i> (pp. 283-285).')
    })
    ...
    it('Include place and publisher should be separated by a colon.', function () {
      ...
      helper.getDescription('refereedConferencePaper', publication, 'sv', 'apa').should.equal(' I <i>The host title: The host subtitle.</i> (s. 283-285). Bräkne-Hoby: Advanced Knowledge International')
      helper.getDescription('refereedConferencePaper', publication, 'en', 'apa').should.equal(' In <i>The host title: The host subtitle.</i> (pp. 283-285). Bräkne-Hoby: Advanced Knowledge International')
    })
    ...
    it('ConferenceName should be preceded by "Presenterad vid"/"Presented at.', function () {
      ...
      helper.getDescription('refereedConferencePaper', publication, 'sv', 'apa').should.equal(' Presenterad vid <i>MILINF</i>.')
      helper.getDescription('refereedConferencePaper', publication, 'en', 'apa').should.equal(' Presented at <i>MILINF</i>.')
    })
  })
  ...
  describe('Rules for formatting the description of a publication of the type thesis.', function () {
    it('Thesis correctly formatted.', function () {
      ...
      helper.getDescription('refereedScienceThesis', publication, 'sv', 'apa').should.equal(' (Doktorsavhandling , Advanced Knowledge International, Bräkne-Hoby, TRITA-TEST 2017:29). Hämtad från <a target="_blank" href="http://urn.kb.se/resolve?urn=urn:nbn:se:kth:diva-206750">http://urn.kb.se/resolve?urn=urn:nbn:se:kth:diva-206750</a>')
      helper.getDescription('refereedScienceThesis', publication, 'en', 'apa').should.equal(' (Doctoral thesis , Advanced Knowledge International, Bräkne-Hoby, TRITA-TEST 2017:29). Retrieved from <a target="_blank" href="http://urn.kb.se/resolve?urn=urn:nbn:se:kth:diva-206750">http://urn.kb.se/resolve?urn=urn:nbn:se:kth:diva-206750</a>')
    })
  })
  ...
  describe('Rules for formatting the description of a publication of the type Report.', function () {
    it('seriesTitle, seriesIssueNr, place and publisher should be correctly formatted.', function () {
      ...
      helper.getDescription('refereedBook', publication, 'sv', 'apa').should.equal(' (Testserie 2012:06). Bräkne-Hoby: Advanced Knowledge International')
    })
  })
