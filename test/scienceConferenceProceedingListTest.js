...
describe('PublicationUtil', function () {
  ...
  describe('Rules for adding a publication to list of science conference proceedings.', function () {
    it('should add one publication to the list of scienceConferenceProceedings when science, and publication type report', function (
      done
    ) {
    ...
    it('should add one publication to the list of scienceConferenceProceedings when refereed, and publication type report', function (
      done
    ) {
      var userPublications = {
        publications: [
    ...
    it('should add one publication to the list of scienceConferenceProceedings when other, and publication type report', function (
      done
    ) {
      var userPublications = {
        publications: [
    ...
    it('should NOT add a publication to the list of scienceConferenceProceedings when publication type code casing is BAD', function (
      done
    ) {
      var userPublications = {
        publications: [
