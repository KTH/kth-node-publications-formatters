...
describe('PublicationUtil', function () {
  ...
  describe('Rules for adding a publication to list of science collections.', function () {
    it('should add one publication to the list of scienceCollections when science, and publication type collection', function (
      done
    ) {
      ...
      var numPublications = jsonResult.scienceCollections.length
    ...
    it('should add one publication to the list of scienceCollections when refereed, and publication type collection', function (
      done
    ) {
      var userPublications = {
        publications: [
    ...
    it('should add one publication to the list of scienceCollections when other, and publication type collection', function (
      done
    ) {
      var userPublications = {
        publications: [
    ...
    it('should NOT add a publication to the list of scienceCollections when publication type code casing is BAD', function (
      done
    ) {
      var userPublications = {
        publications: [
